...
extern "C"{
  ...
  */
  void DS3231_SetRegByte(uint8_t regAddr, uint8_t val) {
    ...
    uint8_t value[1] = { val };
    HAL_I2C_Mem_Write(_ds3231_ui2c, DS3231_I2C_ADDR << 1, regAddr, 1, value, 1, DS3231_TIMEOUT);
  }
  ...
  */
  uint8_t DS3231_GetRegByte(uint8_t regAddr) {
    ...
    uint8_t value[1];
    HAL_I2C_Mem_Read(_ds3231_ui2c, DS3231_I2C_ADDR << 1, regAddr, 1, value, 1, DS3231_TIMEOUT);
    //return val;
    return value[0];
  }
